      ...
      <div className="up z-10  w-full absolute overflow-hidden">
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-end items-end h-[100vh]">
            <p className="text-white w-2xl text-2xl mb-20 ">
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-end items-end h-[100vh]">
            <p className="text-white text-center text-2xl mb-20 ">
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-end items-end h-[100vh]">
            <p className="text-white w-2xl text-2xl ">
      ...
      <div className="down z-[-20]  w-full  absolute  overflow-hidden">
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-center h-[50vh]">
            ...
            <h1 className="text-[18rem] leading-44 text-white font-bold ">SILVIA</h1>
          </div>
        </div>
        <div className="page h-screen">
          <div className="container m-auto flex flex-col justify-center items-center h-[50vh]">
            <h1 className="text-[18rem] leading-44 text-white font-bold ">LS V8</h1>
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-center items-end h-[50vh]">
            <h4 className="text-[5rem] text-white font-bold mt-80">Japanese</h4>
            <h1 className="text-[18rem] leading-44 text-white font-bold ">Legend</h1>
          </div>
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-center items-center h-[50vh]">
            ...
            <h1 className="text-[3rem] leading-20 text-white font-bold  mb-20">"it’s a statement of style, speed, and pure driving passion."</h1>
          </div>
        </div>
