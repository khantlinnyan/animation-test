...
export default function Home() {
  return (
    <div className="h-[800vh] relative z-[-100]" >
      ...
      <div className="up z-10 h-screen w-full absolute ">
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-end items-end h-[100vh]">
            <p className="text-white w-2xl text-2xl mb-20 mix-blend-exclusion">
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-end items-end h-[100vh]">
            <p className="text-white text-center text-2xl mb-20 mix-blend-exclusion">
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-end items-end h-[100vh]">
            <p className="text-white w-2xl text-2xl mix-blend-exclusion">
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-end items-center h-[100vh]">
            <p className="text-white  text-2xl mix-blend-exclusion mb-10">
              This Website Made by <a  href="https://www.wanttoknow.me/" className="underline ">Farid Mustafayev</a>
            </p>
          </div>
        </div>
      </div>
      <div className="down z-[-20]  w-full  absolute">
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-center h-[50vh]">
            <h4 className="text-[5rem] text-white font-bold">Nissan</h4>
            <h1 className="text-[18rem] leading-44 text-white font-bold mix-blend-exclusion">SILVIA</h1>
          </div>
        </div>
        <div className="page h-screen">
          <div className="container m-auto flex flex-col justify-center items-center h-[50vh]">
            <h1 className="text-[18rem] leading-44 text-white font-bold mix-blend-exclusion">LS V8</h1>
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-center items-end h-[50vh]">
            <h4 className="text-[5rem] text-white font-bold">Japanese</h4>
            <h1 className="text-[18rem] leading-44 text-white font-bold mix-blend-exclusion">Legend</h1>
          </div>
        ...
        <div className="page h-screen ">
          <div className="container m-auto flex flex-col justify-center items-center h-[50vh]">
            <h4 className="text-[4rem] text-white font-bold">The Nissan Silvia isn’t just a car</h4>
            <h1 className="text-[3rem] leading-20 text-white font-bold mix-blend-exclusion mb-20">"it’s a statement of style, speed, and pure driving passion."</h1>
          </div>
        </div>
